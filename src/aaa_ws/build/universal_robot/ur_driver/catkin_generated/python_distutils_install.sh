...
echo_and_run cd "/home/ubuntu/aaa_ws/src/universal_robot/ur_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ubuntu/aaa_ws/src/universal_robot/ur_driver/setup.py" \
     \
    build --build-base "/home/ubuntu/aaa_ws/build/universal_robot/ur_driver" \
    install \
    --root="${DESTDIR-/}" \
