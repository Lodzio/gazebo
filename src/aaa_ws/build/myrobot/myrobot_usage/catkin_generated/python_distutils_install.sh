...
echo_and_run cd "/home/ubuntu/aaa_ws/src/myrobot/myrobot_usage"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ubuntu/aaa_ws/src/myrobot/myrobot_usage/setup.py" \
     \
    build --build-base "/home/ubuntu/aaa_ws/build/myrobot/myrobot_usage" \
    install \
    --root="${DESTDIR-/}" \
