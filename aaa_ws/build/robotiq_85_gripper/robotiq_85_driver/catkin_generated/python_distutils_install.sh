...
echo_and_run cd "/home/ubuntu/aaa_ws/src/robotiq_85_gripper/robotiq_85_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ubuntu/aaa_ws/src/robotiq_85_gripper/robotiq_85_driver/setup.py" \
     \
    build --build-base "/home/ubuntu/aaa_ws/build/robotiq_85_gripper/robotiq_85_driver" \
    install \
    --root="${DESTDIR-/}" \
